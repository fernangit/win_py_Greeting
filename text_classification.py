...
# ラベル
labels = ['Dailylife', 'Schoollife', 'Travel', 'Health', 'Entertainment', 'ReserveMeetingroom', 'Call', 'Praise', 'Encouragement', 'SetPlan', 'MAU', 'Greeting', 'CallOut', 'Terminate', 'Positive', 'Negative']
